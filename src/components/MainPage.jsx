    ...
    return (
        <div className="mx-8 mt-4 ultra-xs:mx-0">
            <div className="mx-4 mt-20 ultra-xs:mx-0">
                <h1 className=" text-5xl text-slate-800 w-1/2 font-bold text-center mx-auto ultra-xs:w-4/5 ultra-xs:text-3xl xxs:w-4/5 xxs:text-3xl xs:text-3xl xs:w-full sm:w-full md:w-4/5">Collect all your product feedback <span className="text-blue-600">in one location</span></h1>
                <div className="mt-14">
